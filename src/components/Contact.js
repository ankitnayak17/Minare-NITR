                ...
                <form ref={Query_Form} onSubmit={handleSubmit}>
                  <Row>
                    <Col size={12} sm={6} className="px-1">
                      <input type="text" name='first_name' value={formDetails.firstName }required placeholder="First Name" onChange={(e) => onFormUpdate('firstName', e.target.value)} />
                    </Col>
                    <Col size={12} sm={6} className="px-1">
                    ...
                    <Col size={12} sm={6} className="px-1">
                      <input type="email" name="email_id" value={formDetails.email} required placeholder="Email Address" onChange={(e) => onFormUpdate('email', e.target.value)} />
                    </Col>
                    <Col size={12} sm={6} className="px-1">
                    ...
                    <Col size={12} className="px-1">
                      <textarea rows="2" name="query" value={formDetails.message} required placeholder="Type your Query/Message here..." onChange={(e) => onFormUpdate('message', e.target.value)}></textarea>
